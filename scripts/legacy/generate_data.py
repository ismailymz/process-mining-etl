...
Bu, projenin ilk versiyonunda kullanılan sentetik veri üreticisiydi. Proje
daha sonra BPI Challenge 2012 gerçek event log verisine geçirildi (bkz.
scripts/legacy/xes_to_csv.py, README). Bu dosya migration hikayesinin
referansı olarak saklanıyor, aktif pipeline tarafından kullanılmıyor.
