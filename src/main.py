...
def main() -> None:
    ...
    # extract_event_log, transform_event_log, and load_to_sqlite each log
    # their own completion (row counts, table name) -- main.py only logs the
    # one action it performs directly: writing the intermediate CSV.
    ...
    logger.info("Saved cleaned CSV: %s", processed_file_path)
